...
Версия программы соответствовует номеру лабораторной работы. Текущая версия «0.0.0.11» из «0.0.0.21». 

## Архитектура
<img src="doc/UMLДиаграммы/ДиаграммаПакетовГоризонтально.png" width="100%"/>
